...
public class MotionDetectorSystem {
	...
	public static void main(String[] args) {
		...
		ObservableButton resetButton = new seiot.modulo_lab_3_2.devices.emu.ObservableButton(7,"reset");
		ObservableMotionDetectorSensor pir = new seiot.modulo_lab_3_2.devices.emu.ObservablePirSensor(2);
